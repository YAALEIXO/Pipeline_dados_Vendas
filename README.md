...
## Objetivo
Este projeto serve como exemplo de pipeline de dados  para demonstrar competências em Engenharia de Dados, incluindo ingestão, validação e persistência em banco relacional.
